...
{	
	...
	/**
	 * Le nombre de threads cr�e par minute par ce noeud (cf NoeudBase)
	 */
	...
	/**
	 * La repr�sentation d'un thread souhaitant migrer sur ce noeud
	 *
	 */
	...
	/**
	 * Constructeur
	 * @param info l'info servant � construire le noeud
	 * @param f le fidele poss�dant ce noeud
	 */
	 ...
	 * alors une autorisation de migration est envoy�e.
	 */
	...
	/**
	 * Demande � la couche r�seau d'initier une connexion en tant que client vers le noeud voisin
	 * @param infoVoisin les infos du futur voisin qui attent en tant que serveur
	 * @param distance le noeud voisin doit la conna�tre �galement
	 */
	...
	/**
	 * Transmet l'info de ce noeud au fid�le
	 */
	...
	/**
	 * Transmet l'info du thread au fid�le
	 * @param w
	 */
	...
	/**
	 * Effectue une demande de migration de la part d'un thread au noeud sur lequel il souhaite se d�placer
	...
	/**
	 * Envoie � un noeud une autorisation de migration pour un thread
	...
	/**
	 * Indique � un thread qu'il a le droit d'effectuer sa migration
	 * @param nomMigreur le nom du thread autoris� � migrer
	 */
	 ...
	 * Utilis�e uniquement par NoeudBase !!
	 * @param w
	 */
	...
	/**
	 * Effectue la migration d'un thread apr�s que celui-ci ait recu l'autorisation.
	 * Note : le thread dispose d�j� des informations necessaires � sa migration,
	 * qui ont �t� d�termin�e dans la fonction "demanderAutorisationMigration" de la classe Warrior
	 * @param thread
	 */
	...
	/**
	 * Demande � chaque voisin les informations le concernant
	 * @param nomDemandeur le nom du thread souhaitant r�cup�rer les infos
	 */
	...
	/**
	 * Recherche le thread ayant demand� les infos, et les lui donne.
	 * Cette fonction est appel�e autant de fois qu'il y'a de noeuds voisins
	 * @param nomDemandeur le thread ayant demand� les infos des voisins
	...
	/**
	 * Ajoute un noeud voisin (pas un Noeud � proprement parler, seulement sa repr�sentation :p)
	 * @param idVoisin l'id de ce nouveau voisin
	 * @param distanceVoisin la distance � ce voisin
	 */
	...
	/**
	 * Idem, mais ajoute le voisin � un endroit particulier dans le tableau des voisins.
	 * Cela pour faire la correspondance entre les interfaces r�seaux et les noeudsVoisins.
	 * @param idVoisin
	...
	/**
	 * Retourne la liste des propri�taires de chaque thread pr�sents sur le noeud
	 * @return
	 */
	...
	/**
	 * Retourne la distance du voisin situ� � l'indice i
	 * @param i
	 * @return
	 */
	...
	/**
	 * Retourne le noeud voisin situ� � l'indice i
	 * @param i
	 * @return
	 */
	...
	/**
	 * @return la list des threads pr�sents sur le noeud
	 */
